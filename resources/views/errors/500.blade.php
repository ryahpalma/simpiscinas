    ...
    <section class="bg-white">
        <div class="mx-auto max-w-screen-xl py-12 px-4 lg:py-24 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h1 class="text-red-800 mb-4 text-7xl font-extrabold tracking-tight lg:text-9xl">500</h1>
                <p class="text-gray-90 mb-4 text-3xl font-bold tracking-tight md:text-4xl">Erro desconhecido.</p>
                <p class="mb-4 text-lg font-light text-gray-700">Desculpe, mas não conseguimos processar os dados. Chame o suporte para resolver este problema</p>
