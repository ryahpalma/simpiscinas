    ...
    <div class="mx-auto px-4 pt-12 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
            ...
            <div class="md:max-w-md">
                ...
                <div class="mx-auto mt-4 lg:max-w-sm">
                    <p class="text-deep-purple-50 text-sm">
                        CNPJ 30.153.358/0001-15.<br>
                        (13) 3202-7509 - Santos<br>
                        (11) 4837-5709 - São Paulo<br>
                        (12) 3500-0046 - São José dos Campos<br>
                        (11) 4837-5709 - São Bernardo do Campo
                    </p>
                </div>
            </div>
        ...
        <div class="flex flex-col justify-between border-t border-gray-300 pt-5 pb-10 sm:flex-row">
            ...
            <div class="mt-4 flex items-center space-x-4 sm:mt-0">
                <a href="https://www.reclameaqui.com.br/empresa/sim-piscinas/" class="hover:text-pink-accent-800 text-white transition-colors duration-300">
                    <i class='bx bxs-happy bx-sm'></i>
                </a>
