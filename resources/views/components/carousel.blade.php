<div {{ $attributes->merge(['class' => 'glide']) }}>
    <div class="glide__track rounded border border-gray-100" data-glide-el="track">
    ...
    <div class="glide__arrows" data-glide-el="controls">
        <button type="button" class="group absolute top-0 left-0 z-30 flex h-full cursor-pointer items-center justify-center px-4 focus:outline-none" data-glide-dir="<">
            <span class="inline-flex h-12 w-12 items-center justify-center rounded-full border-4 bg-pink-accent-800 group-hover:bg-pink-accent-800/70 group-focus:outline-none group-focus:ring-4 group-focus:ring-pink-accent-800 sm:h-14 sm:w-14">
