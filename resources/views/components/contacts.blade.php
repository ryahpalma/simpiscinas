<div class="mx-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
    ...
    <div class="row-gap-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div class="flex flex-col justify-between rounded border p-5 shadow-sm">
            ...
            <div class="flex flex-row">
                <i class='bx bx-sm bxs-phone text-blue-accent-800'></i>
                <a href="tel:1235000046" aria-label="" class="inline-flex items-center font-semibold text-black transition-colors duration-200 hover:text-gray-600">(12) 3500-0046</a>
            </div>
        </div>
        <div class="flex flex-col justify-between rounded border p-5 shadow-sm">
            <div>
            ...
            <div class="flex flex-row">
                <i class='bx bx-sm bxs-phone text-blue-accent-800'></i>
                <a href="tel:1332027509" aria-label="" class="inline-flex items-center font-semibold text-black transition-colors duration-200 hover:text-gray-600">(13) 3202-7509</a>
            </div>
        </div>
        <div class="flex flex-col justify-between rounded border p-5 shadow-sm">
            <div>
